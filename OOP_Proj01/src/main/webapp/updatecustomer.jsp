...
<hr class="new1">
	...
	<form action = "update" method = "post" class="tr">
		Customer ID<input type = "text" name = "cusid" value = "<%= id %>" readonly class="t1"><br>
		Name<input type = "text" name = "name" value = "<%= name %>" class="t1"><br>
		Email <input type = "text" name = "email" value = "<%= email %>" class="t1"><br>
		Phone Number <input type = "text" name = "phone" value = "<%= phone %>" class="t1"><br>
		User Name <input type = "text" name = "uname" value = "<%= userName %>" class="t1"><br>
		Password <input type = "password" name = "pass" value = "<%= password %>" class="t1"><br>
		
		<input type = "submit" name = "submit" value = "Updtate My Data" class="btn"><br>
