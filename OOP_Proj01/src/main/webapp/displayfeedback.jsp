...
<html>
    <head>
        ...
        container input[type="update"]:hover {
            background-color: #0056b3;
        }
.btn {
	...
	<a href = "${feedupdate}">
	<input type = "button" name = "update" value = "Update My Feedbck" class="btn">
	</a>
	<br>
	...
	<a href="${feeddelete}">
	<input type="button" name="delete" value="Delete My Feedback" class="btn">
	</a>
    </div>
