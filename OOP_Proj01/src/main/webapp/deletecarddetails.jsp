...
<br><br><br><br>
	<h1 class=h11>Card Details Delete</h1>
	<div class="center-container">
        <div class="row">
            <div class="col-75"> 
                <div class="container1">

                    <h2 class="b"><b>Are You Want To Delete Details ? </b></h2>
	...
	<table>
		...
		<tr class="tr">
			<td>Card number</td>
			<td><input type = "text" name = "cardNum" value = "<%= cardNum %>"readonly></td>
		</tr>
		<tr class="tr">
			<td>Month</td>
			<td><input type = "text" name = "month" value = "<%= month %>"readonly></td>
		</tr>
	...
	<br>
	<input type="submit" name="submit" value="Delete Card Details" class="btn">
	</form>
