...
<hr class = "new1">
    ...
    <div class="container">
        <h2>Delete Event Details</h2>
        
        <form action="deleteevent" method="post" id="delete-event">
            <label for="id"> Event ID:</label>
            <input type="text" name="id" value = "<%= id %>" readonly><br>        
        
            <label for="event_name"> Event Name:</label>
            <input type="text" name="event_name" value = "<%= event_name %>" ><br>
            
            <label for="cus_name">Customer Name:</label>
            <input type="text" name="cus_name" value = "<%= cus_name %>" readonly ><br>
            
            <label for="event_type">Event Type:</label>
            <input type="text" name="event_type" value = "<%= event_type %>" ><br>
            ...
            <input type="text" name="specialRequests" value = "<%= specialRequests %>"><br>
            
            <label for="theme">Theme:</label>
            <input type="text" name="theme" value = "<%= theme %>" ><br>
            
            <label for="no_of_guests">Number Of Guests:</label>
            <input type="text" name="no_of_guests" value = "<%= no_of_guests %>" ><br>
            
            <input type="submit" name="submit" value="Delete Event Details">
        </form>
    </div>
